...
cdef class JvmField:
    ...
    cdef object get_boolean(self, JNIEnv* env, jclass clazz, jfieldID fid)
    cdef object get_byte(self, JNIEnv* env, jclass clazz, jfieldID fid)
    cdef object get_char(self, JNIEnv* env, jclass clazz, jfieldID fid)
    cdef object get_short(self, JNIEnv* env, jclass clazz, jfieldID fid)
    cdef object get_int(self, JNIEnv* env, jclass clazz, jfieldID fid)
    cdef object get_long(self, JNIEnv* env, jclass clazz, jfieldID fid)
    cdef object get_float(self, JNIEnv* env, jclass clazz, jfieldID fid)
    cdef object get_double(self, JNIEnv* env, jclass clazz, jfieldID fid)
    cdef object get_object(self, JNIEnv* env, jclass clazz, jfieldID fid)
